<x-layouts.app>
    ...
    <x-layouts.content title="Editar Orden de Trabajo" subtitle="" name="Ordenes de Trabajo">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <form method="post" action="{{ route('ordentrabajo.update',  $ordenTrabajo['id']) }}">
                        @csrf
                        <div class="row px-4">
                                ...
                                <div class="d-flex flex-md-wrap align-items-center">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="fechaIngreso" name="fechaIngreso"
                                            ...
                                            value="{{ old('fechaIngreso', formatearFecha($ordenTrabajo['fecha_inicio'])) }}"
                                ...
                                <div class="d-flex flex-md-wrap align-items-center">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="fechaEgreso" name="fechaEgreso" placeholder="dd/mm/aaaa"
                                            class="form-control flatpickr" value="{{ old('fechaEgreso', formatearFecha($ordenTrabajo['fecha_fin'])) }}"
                                            style="background: transparent; cursor: pointer" readonly>
                                        <div class="input-group-append">
                                            <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="d-flex flex-md-wrap align-items-center">
                                        ...
                                        <select class="form-control" data-toggle="select2" id="cotizacion_id"
                                            ...
                                            @if ($cotizacion['id'] == old('cotizacion_id', $ordenTrabajo['cotizacion_id'])) selected @endif>
                                ...
                                <div class="form-group">
                                    <div class="d-flex flex-md-wrap align-items-center">
                                        ...
                                        <select class="form-control" id="estado"
                                            name="estado">
                                            <option value="Ingresado" {{ old('estado', $ordenTrabajo['estado']) === 'Ingresado' ? 'selected' : '' }}>
                                                Ingresado
                                            </option>
                                            <option value="En proceso" {{ old('estado', $ordenTrabajo['estado']) === 'En proceso' ? 'selected' : '' }}>
                                                En proceso
                                            </option>
                                            <option value="Esperando repuesto" {{ old('estado', $ordenTrabajo['estado']) === 'Esperando repuesto' ? 'selected' : '' }}>
                                                Esperando repuesto
                                            </option>
                                            <option value="Reparado" {{ old('estado', $ordenTrabajo['estado']) === 'Reparado' ? 'selected' : '' }}>
                                                Reparado
                                            </option>
                                            <option value="Entregado" {{ old('estado', $ordenTrabajo['estado']) === 'Entregado' ? 'selected' : '' }}>
                                                Entregado
                                            </option>
                                        </select>
                                        @error('estado')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="descripcion" id="descripcion" rows="5"
                                        placeholder="">{{ old('descripcion', $ordenTrabajo['descripcion']) }}</textarea>
                                    @error('descripcion')
                                    <span class="error text-danger">* {{ $message }}</span>
                                    @enderror
                                </div>
