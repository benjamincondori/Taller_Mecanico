        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <form class="px-4 pt-2 pb-2" action="{{ route('vehiculos.update', $vehiculo['id']) }}"
                        method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="marca_id" id="marca_id">
                                        ...
                                        <option value="{{ $marca['id'] }}" @if ($marca['id']==old('marca_id',
                                            $vehiculo['marca_id'])) selected @endif>{{ $marca['nombre'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('marca_id')
                                    <span class="error text-danger">* {{ $message }}</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="modelo_id" id="modelo_id">
                                        ...
                                        <option value="{{ $modelo['id'] }}" @if ($modelo['id']==old('modelo_id',
                                            $vehiculo['modelo_id'])) selected @endif>{{ $modelo['nombre'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('modelo_id')
                                    <span class="error text-danger">* {{ $message }}</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="cliente_id" id="cliente_id">
                                        ...
                                        <option value="{{ $cliente['id'] }}" @if ($cliente['id']==old('cliente_id',
                                            $vehiculo['cliente_id'])) selected @endif>{{ $cliente['nombre'] }} {{
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="tipo_vehiculo_id" id="tipo_vehiculo_id">
                                        ...
                                        @if($tipoVehiculo['id']==old('tipo_vehiculo_id',
                                            $vehiculo['tipo_vehiculo_id'])) selected @endif>{{ $tipoVehiculo['nombre']
                                            }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kilometraje" name="kilometraje"
                                        placeholder="121212" value="{{ old('kilometraje', $vehiculo['kilometraje']) }}">
                                    @error('kilometraje')
                                    <span class="error text-danger">* {{ $message }}</span>
                                    @enderror
                                </div>
