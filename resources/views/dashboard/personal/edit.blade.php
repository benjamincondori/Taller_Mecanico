<x-layouts.app>
    ...
    <x-layouts.content title="Editar Personal" subtitle="" name="Personal">
            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="form-group px-4 pt-2">
                        ...
                        <h3 class="fs-1 d-inline-block ml-1">Editar Personal</h3>
                    </div>

                    <form class="px-4 pt-2 pb-2" action="{{ route('personal.update', $personal['id']) }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    placeholder="1234567" value="{{ old('ci', $personal['ci']) }}" >
                                    @error('ci')
                                    <span class="error text-danger">* {{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('puesto_id') is-invalid @enderror" id="puesto_id" name="puesto_id">
                                        ...
                                        @foreach ($puestos as $puesto)
                                            ...
                                            @if ($puesto['id'] == old('puesto_id', $personal['puesto_id']))
                                                selected
                                            @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('rol_id') is-invalid @enderror" id="rol_id" name="rol_id">
                                        ...
                                        @foreach ($roles as $rol)
                                            <option value="{{ $rol['id'] }}" 
                                            @if ($rol['id'] == old('rol_id', $personal['usuario']['rol_id']))
                                                selected
                                            @endif
                                            >{{ $rol['nombre'] }}</option>
                                        @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        {{ old('genero', $personal['genero']) === 'F' ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-control custom-radio mt-1">
                                        ...
                                        {{ old('genero', $personal['genero']) === 'M' ? 'checked' : '' }}>
