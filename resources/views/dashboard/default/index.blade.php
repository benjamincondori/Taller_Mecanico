            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card-box">
                        ...
                        <div class="mt-2">
                            <div class="progress progress-sm m-0">
                                <div class="progress-bar" role="progressbar" aria-valuenow="18" aria-valuemin="0"
            ...
            <div class="row">
                <div class="col-md-6 col-xl-3">
                    <div class="card-box widget-user">
                        <img src="assets/images/users/user-1.jpg" class="img-responsive rounded-circle img-thumbnail"
                            alt="user">
                        <div class="mt-3">
                            <h5 class="mb-1">Chadengle</h5>
                            <p class="text-muted mb-0 font-13">coderthemes@gmail.com</p>
                            <div class="user-position">
                                <span class="text-warning text-uppercase font-13 font-weight-bold">Admin</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card-box widget-user">
                        <img src="assets/images/users/user-2.jpg" class="img-responsive rounded-circle img-thumbnail"
                            alt="user">
                        <div class="mt-3">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card-box widget-user">
                        <img src="assets/images/users/user-4.jpg" class="img-responsive rounded-circle img-thumbnail"
                            alt="user">
                        <div class="mt-3">
                            <h5 class="mb-1">Stillnotdavid</h5>
                            <p class="text-muted mb-0 font-13">coderthemes@gmail.com</p>
                            <div class="user-position">
                                <span class="text-success text-uppercase font-13 font-weight-bold">Admin</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card-box widget-user">
                        <img src="assets/images/users/user-10.jpg" class="img-responsive rounded-circle img-thumbnail"
                            alt="user">
                        <div class="mt-3">
