        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <form id="nuevoProducto" action="{{ route('cotizacionServicio.store',$id)}}" method="post">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <button type="submit" class="btn btn-primary" id="agregarProducto">Agregar Producto</button>
                        </div>
                    </div>
                    </form>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="precioTotal" name="precioTotal" readonly style="text-align: left" value="0">
                                    </div>
                                </div>
                            </div>
